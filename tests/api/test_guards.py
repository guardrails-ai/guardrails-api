...
# Assuming these imports exist in your FastAPI project
...
def test_validate__parse(mocker):
    ...
    response = client.post("/guards/My%20Guard's%20Name/validate", json={
...
def test_openai_v1_chat_completions__raises_404(mocker):
    ...
    response = client.post("/guards/My%20Guard's%20Name/openai/v1/chat/completions", json={
