...
class TestInitializeTracer(unittest.TestCase):
    ...
    @patch('guardrails_api.otel.traces.traces_are_disabled')
    @patch.dict('os.environ', {'OTEL_TRACES_EXPORTER': 'console', 'OTEL_PROCESS_IN_BATCH': 'true'})
    def test_initialize_with_console_exporter(
        self, mock_disabled, mock_get_provider, mock_get_exporter,
        mock_set_processors, mock_get_tracer
    ):
    ...
    @patch('guardrails_api.otel.traces.trace.get_tracer_provider')
    @patch('guardrails_api.otel.traces.traces_are_disabled')
    @patch.dict('os.environ', {'OTEL_TRACES_EXPORTER': 'console', 'OTEL_PROCESS_IN_BATCH': 'false'})
