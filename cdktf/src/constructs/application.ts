    ...
    this._lambdaFunction = new LambdaFunction(this, `${id}-lambda-function`, {
      ...
      environment: {
        variables: {
          ...
          OTEL_TRACE_SINK: `https://${traceIngestionPipeline.endpoint}:443/traces/ingest`,
          OTEL_METRIC_SINK: `https://${metricIngestionPipeline.endpoint}:443/metrics/ingest`,
          OTEL_LOG_SINK: `https://${logIngestionPipeline.endpoint}:443/logs/ingest`,
