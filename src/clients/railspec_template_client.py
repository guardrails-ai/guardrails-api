...
class RailspecTemplateClient:
    ...
    def get_railspec_template(self, owner: str, name: str) -> RailspecTemplateStruct:
        ...
        railspec_template_item = (
            ...
            .filter((RailspecTemplateItem.owner = owner), name=name)
            .first()
        )
        ...
        return RailspecTemplateStruct.from_railspec_template_item(railspec_template_item)

    def get_railspec_template_item(self, owner: str, name: str) -> RailspecTemplateItem:
        return (
            self.pgClient.db.session.query(RailspecTemplateItem)
    ...
    def get_railspec_templates(self, owner: str) -> List[RailspecTemplateStruct]:
        ...
        return [RailspecTemplateStruct.from_railspec_template_item(gi) for gi in railspec_template_items]

    def create_railspec_template(self, owner: str, template: RailspecTemplateStruct) -> RailspecTemplateStruct:
    ...
    def update_railspec_template(self, owner: str, name: str, template: RailspecTemplateStruct) -> RailspecTemplateStruct:
        railspec_template_item = self.get_railspec_template_item(owner, name)
        if railspec_template_item is None:
            raise HttpError(
                status=404,
                message="NotFound",
    ...
    def upsert_railspec_template(self, owner: str, name: str, template: RailspecTemplateStruct) -> RailspecTemplateStruct:
        railspec_template_item = self.get_railspec_template_item(owner, name)
    ...
    def delete_railspec_template(self, owner: str, name: str) -> RailspecTemplateStruct:
        ...
        self.pgClient.db.session.commit()
        template = RailspecTemplateStruct.from_railspec_template_item(railspec_template_item)
        return template
